...
HEADERS += src/cmasternodevotequeue.h
HEADERS += src/cmnqueuesnapshot.h
HEADERS += src/cmasternodevotetracker.h
...
HEADERS += src/types/mapprevtx_t.h
...
HEADERS += src/enums/changetype.h
HEADERS += src/enums/dberrors.h
...
HEADERS += src/thread/cmutexlock.h
HEADERS += src/thread/csemaphore.h
HEADERS += src/thread/csemaphoregrant.h
HEADERS += src/thread/safety.h
