...
bool IsSporkActive(int nSporkID)
{
	...
	else
	{
		...
		if(nSporkID == SPORK_14_TEST_SIGNATURES) r = SPORK_14_TEST_SIGNATURES_DEFAULT;
		if(nSporkID == SPORK_15_VOTED_CONSENSUS_ACTIVATION) r = SPORK_15_VOTED_CONSENSUS_ACTIVATION_DEFAULT;
